...
const SkillsSection = () => {
  const skillCategories = [
    ...
    },
    {
      ...
      skills: [
        ...
        { name: "Mariadb", icon: <SiMongodb className="w-4 h-4 text-[#47A248]" /> },
        { name: "Mysql", icon: <BsGrid1X2 className="w-4 h-4 text-[#FF6C37]" /> },
  ...
  return (
    <main className="pt-15 lg:pt-0 text-white min-h-screen bg-[#04081A] relative">
      ...
      {/* 🔧 Skills Content */}
      <section className="container mx-auto px-4 py-11 relative z-20">
